...
$resultsmech = mysqli_query($db, "SELECT * FROM bill WHERE mechnmame='$mech'");
...
<body">
    ...
    <div class="container">
        ...
        <div class="col-xl-3 pt-5">
            ...
            <h3>Confirmed Inspection Reports By Customers</h3>
                                       ...
                                       <div class="table-responsive">
                                        ...
                                        <thead>
                                          ...
                                          <th scope="col">Confirmed Inspection Report</th>
                                        ...
                                        <?php while ($rowmech =mysqli_fetch_array($resultsmech)){?>
                                          <tr>
                                              <td><?php echo $rowmech['jobid']; ?></td>
                                              <td><?php echo $rowmech['insdate']; ?></td>
                                              <td><?php echo $rowmech['ins_custname']; ?></td>
                                               <td><?php echo $rowmech['ins_nic']; ?></td>
                                                   <td><?php echo $rowmech['ins_mobile']; ?></td>
                                               <td><?php echo $rowmech['ins_veh_regno']; ?></td>
...
<?php
                                                $sendt0cas="";
                                                $sendt0cas="checked";
                                              if($sendt0cas!=$rowmech['status']){
                                                echo '<td><button type="submit" name="" class="btn btn-danger" disabled>Sent to Cashier</button></td>';
                                   
                                              }else{
                                                    
                                                echo  '<td><button type="submit" name="" class="btn btn-success">View Report</button></td>';
                                              }
                                              ?>
