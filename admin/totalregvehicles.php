<?php 
    ...
    $sqlttlveh = "SELECT * FROM regvehicles";
?> 
        ...
        <div class="page-container3">
            ...
            <section>
                <div class="container">
                    ...
                    <?php if($resulttlveh = mysqli_query($db,$sqlttlveh)) :?>
                      <tbody>
                        <?php while($rowttlveh =mysqli_fetch_array($resulttlveh)) :?>
                        <?php echo "<tr>"; ?> 
                        
                        <?php echo "<td>" . $rowttlveh['nic'] . "</td>"; ?>
                        <?php echo "<td>" . $rowttlveh['vehicle_reg_no'] . "</td>"; ?> 
                        <?php echo "<td>" . $rowttlveh['vehicle_type'] . "</td>"; ?>  
                     ...
                     <?php endwhile ?>
                      ...
                      <?php mysqli_free_result($resulttlveh); ?>
                    <?php endif?>
                    <?php mysqli_close($db); ?>
                    </table>
