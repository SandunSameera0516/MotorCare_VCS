<?php 
    ...
    $sqltotalmech = "SELECT * FROM login WHERE user_type='mechanic'";
?> 
        ...
        <div class="page-container3">
            ...
            <section>
                <div class="container">
                    ...
                    <?php if($resulttlmech = mysqli_query($db,$sqltotalmech)) :?>
                      <tbody>
                        <?php while($rowttlm =mysqli_fetch_array($resulttlmech)) :?>
                        <?php echo "<tr>"; ?> 
                        <?php echo "<td>" . $rowttlm['name'] . "</td>"; ?> 
                        <?php echo "<td>" . $rowttlm['nic'] . "</td>"; ?>
                        <?php echo "<td>" . $rowttlm['address'] . "</td>"; ?> 
                        <?php echo "<td>" . $rowttlm['mobile'] . "</td>"; ?>  
                         <?php echo "<td>" . $rowttlm['email'] . "</td>"; ?> 
                        
                        
                         <?php echo "</tr>"; ?> 
                     <?php endwhile ?>
                      </tbody>
                      <?php mysqli_free_result($resulttlmech); ?>
                    <?php endif?>
                    <?php mysqli_close($db); ?>
                    </table>
