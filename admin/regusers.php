<?php 
    ...
    $sqltotalusers = "SELECT * FROM login WHERE user_type='user'";
?> 
        ...
        <div class="page-container3">
            ...
            <section>
                <div class="container">
                    ...
                    <?php if($resulttluser = mysqli_query($db,$sqltotalusers)) :?>
                      <tbody>
                        <?php while($rowttlu =mysqli_fetch_array($resulttluser)) :?>
                        <?php echo "<tr>"; ?> 
                        <?php echo "<td>" . $rowttlu['name'] . "</td>"; ?> 
                        <?php echo "<td>" . $rowttlu['nic'] . "</td>"; ?>
                        <?php echo "<td>" . $rowttlu['address'] . "</td>"; ?> 
                        <?php echo "<td>" . $rowttlu['mobile'] . "</td>"; ?>  
                         <?php echo "<td>" . $rowttlu['email'] . "</td>"; ?> 
                        
                         <?php echo "</tr>"; ?> 
                     <?php endwhile ?>
                      </tbody>
                      <?php mysqli_free_result($resulttluser); ?>
                    <?php endif?>
                    <?php mysqli_close($db); ?>
                    </table>
