<?php 
    ...
    if (isset($_POST['re_password']))
        ...
        if ((strlen($new_pass) < 6)) { 
            array_push($errorpassadmin, "Password lenghth should be greatr than 6"); 
        }
    
        if ($new_pass != $re_pass) {
            array_push($errorpassadmin, "The two passwords do not match");
        }
        ...
        if ($database_password != $old_pass) {
            array_push($errorpassadmin, "Your current password is wrong");
        }
    
    
        if (count($errorpassadmin) == 0) {
    ...
    function display_erroradminpass()
    {
        global $errorpassadmin;
    
        if (count($errorpassadmin) > 0) {
            echo '<div class="error">';
            foreach ($errorpassadmin as $errorpassadmin) {
                echo $errorpassadmin . '<br>';
            }
            echo '</div>';
        }
    }
            ...
            <section>
                <div class="container">
                    <div class="row">
                        ...
                        <form method="post" action="adminresetpass.php">
                        <?php echo display_erroradminpass(); ?>
