...
$inscheck=$_SESSION['user']['nic'];
$sqlinspecti="SELECT * FROM inspection WHERE ins_nic='$inscheck'";
        ...
        <div class="page-container3">
            ...
            <section>
                <div class="container">
                        ...
                        <table class="table table-bordered table-dark ">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col">Check the report</th>
                    ...
                    <?php if($resultmbins = mysqli_query($db,$sqlinspecti)) :?>
                      <tbody>
                        <?php while($row =mysqli_fetch_array($resultmbins)) :?>
                        <?php echo "<tr>"; ?> 
                        <?php echo "<td>" . $row['ins_custname'] . "</td>"; ?> 
                        <?php echo "<td>" . $row['jobins_id'] . "</td>"; ?> 
                        <?php echo "<td>" . $row['ins_nic'] . "</td>"; ?>
                        <?php echo "<td>" . $row['insdate'] . "</td>"; ?> 
                        <?php echo "<td>" . $row['instime'] . "</td>"; ?>  
                         <?php echo "<td>" . $row['ins_veh_regno'] . "</td>"; ?> 
                        
                         <form action="checkinspection.php" method="post">
                          <input type="hidden" name="id" value=<?php echo $row['id']; ?>>
                            <?php
                           $nedtcheck=""; 
                           $nedtcheck= "needtocheck";

                           if($row['status']!=$nedtcheck){
                                echo  '<td><button type="submit" name="" class="btn btn-primary" disabled>Checked</button></td>';
                           }else{
                            echo '<td><button type="submit" name="" class="btn btn-success">Check Report</button></td>';
                           }
                            ?>
                     ...
                     <?php endwhile ?>
                      ...
                      <?php mysqli_free_result($resultmbins); ?>
                    <?php endif?>
                    <?php mysqli_close($db); ?>
                    </table>
