...
if (isset($_POST['id'])) {
    $id = $_POST['id'];
    $queryviewbill = "SELECT * FROM bill where id=" . $id;
}
if(isset($_POST['cncl'])){
    header('location:servisehistory.php');
}
...
<li class="breadcrumb-item active" aria-current="page"><b>View Past Service Reports</b></li>
</ol>
</nav>
        <div class="row py-5">
            <div class="col-md-12">
            <?php $resultbillview=mysqli_query($db,$queryviewbill);?>
                <?php while ($row =mysqli_fetch_array($resultbillview)){?>
                            ...
                            <h5 class="text-center">Checked by -<?php echo $row['mechnmame']; ?></h5>
                                ...
                                <div class="form-group pt-4">
                                    <label for="">Motorcare ID</label>
                                    <input required type="text" readonly name="idins" id="'.$row['id'].'" class="form-control" value="<?php echo $row['id']; ?>">
                                </div>
...
<!-- 
                        ...
                        <div class="row pt-5">
                            ...
                            <div class="col-md-4 pt-2">
                                <input class="form-control" type="text" name="" value="<?php echo $row['total']; ?>" id="mst" readonly> 
                            </div>
                        </div>
                        <div class="row pt-2">
                            <div class="offset-md-6 col-md-2">
                            ...
                            <div class="col-md-4">
                                ...
                                $pkg=$row["pckagename"];
                                    ...
                                    {?>
                                      ...
                                      <input class="form-control" type="text" name="subtotal" value="<?php echo $rowpkg["pck_price"];?>" id="sst" readonly>
                        ...
                        <div class="row pt-2">
                            ...
                            <div class="col-md-4">
                                <input class="form-control" type="text" name="nettotal" value="<?php echo $nettotal ?>" readonly>
                            </div>
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-md-2">
                            <button type="submit" name="cncl" class="btn btn-danger btn-block">Cancel</button>
                            </div>
                        </div>
