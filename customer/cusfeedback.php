...
if (isset($_POST['send_feedback'])){
    ...
    $queryf = "INSERT INTO customer_feedback(name, email, message) 
					  VALUES('$namef','$emailf','$messagef')";
            mysqli_query($db, $queryf);
            
            $_SESSION['feedback']  = "<div class='alert alert-success'>Feedback was sent</div>";
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-9 pt-5">
                              ...
                              <div class="pb-4"><h3>We would like your feedback to improve our service <br></h3><h4> Please leave your feedback below</h4></div>
                        ...
                        <div class="row">
                         ...
                         <div class="form-group">
                            ...
                            <input required type="text"  name="namef" class="form-control" value="<?php echo $_SESSION['user']['name'] ?>" readonly>
                        </div> 

                        <div class="form-group">
                            <label for="">Email</label>
                            <input required type="email"  name="emailf" class="form-control" value="<?php echo $_SESSION['user']['email'] ?>" readonly>
                        </div>  

                        <div class="form-group">
                                 <label for="exampleFormControlTextarea1">Message</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" name="messagef" rows="4"></textarea>
                        </div>  

                        <div class="form-group pull-right">
                            <button class="btn btn-primary" type="submit" name="send_feedback">Send Feedback</button>
                        </div>
